...
import 'package:second_app/Welcome3.dart';
        ...
        child: Stack(
          children: [
            ...
            Container(
                ...
                child: Image(image: AssetImage('Background2_2.png'),height: 383,width:45,)),
            Container(
                margin: EdgeInsets.only(top: 451,left:161),
                child: Image(image: AssetImage('3dots2.png'),height:9,width: 39,)),

            Container(
                margin: EdgeInsets.only(top: 141,left: 311),
                child: Image(image: AssetImage('Background2_3.png'),height: 383,width: 45,)),
            Container(
